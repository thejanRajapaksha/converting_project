...
else if ($functionmenu == 'FinishGoods') {
...
}else if ($functionmenu == 'SparepartFrequency') {
...
else if ($functionmenu == 'Machine Overall Cost') {
        ...
        <div class="nav accordion" id="accordionSidenav">
            ...
            <div class="collapse <?php if($controllermenu=="CRMOrderdetail" | $controllermenu=="CRMDeliverydetail" | $controllermenu=="CRMCompletedorder" | $controllermenu=="Machinealloction" | $controllermenu=="AllocatedMachines"){echo 'show';} ?>" id="collapseCRMOrder" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'FinishGoods'; ?>">Finish Goods</a>
                    <?php } ?>
            ...
            <div class="collapse <?php if($controllermenu=="StockReport" | $controllermenu=="GrnReport" | $controllermenu=="MachineServicesCreated" | $controllermenu=="MachineServicesEmployee" | $controllermenu=="MachineServicesCostAnalysis" | $controllermenu=="UsedServiceItems" | $controllermenu=="MachineRepairsCreated" | $controllermenu=="MachineRepairsEmployee" | $controllermenu=="MachineRepairsCostAnalysis" | $controllermenu=="UsedRepairItems" | $controllermenu=="MachineWIP" | $controllermenu=="CustomerPOWIP" | $controllermenu=="SparepartFrequency" | $controllermenu=="UsedItem" | $controllermenu=="MachineOverallCost"){echo 'show';} ?>" id="collapseReports" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'MachineOverallCost'; ?>">Machine Overall Cost</a><?php } ?>
