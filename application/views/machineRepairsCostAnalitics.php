...
<main>
        ...
        <div class="container-fluid">
            <div class="page-header-content py-3">
                <h1 class="page-header-title font-weight-light">
                    ...
                    <span>Machine Repairs Cost Analysis</span>
                </h1>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid mt-2 p-2">
        ...
        <!-- Monthly Repair Cost Chart -->
        <div class="card mt-3">
            <div class="card-body p-2">
                <h5 class="font-weight-bold text-dark">Monthly Repair Cost Chart</h5>
                <hr>
                <canvas id="monthly_repair_cost_chart"></canvas>
            </div>
        </div>

        <!-- Machine Type and Repair Counts Chart -->
        <div class="card mt-3">
            <div class="card-body p-2">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <h5 class="font-weight-bold text-dark">Machine Type & Repair Counts Chart</h5>
                    <input type="date" class="form-control form-control-sm w-auto" id="machine_type_chart_date_filter" value="<?= date('Y-m-d') ?>" title="Today records shown by default." data-toggle="tooltip" data-placement="left">
                </div>
                <hr>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-sm-3"><strong>Repair No :</strong> <span id="view_repair_no_span"></span></div>
                        <div class="col-sm-3"><strong>Machine Type :</strong> <span id="view_machine_type_span"></span></div>
                    </div>
                        ...
                        <table class="table table-bordered table-sm" id="view_service_detail_table">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-right" id="sub_total_span"></td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="text-right font-weight-bold">Repair Charge</td>
                                    <td class="text-right" id="repair_charge_span"></td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="text-right font-weight-bold">Transport Charge</td>
                                    <td class="text-right" id="transport_charge_span"></td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="text-right font-weight-bold">Total</td>
                                    <td class="text-right" id="total_span"></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
        ...
        buttons: [
            {
                ...
                action: function () {
                    ...
                    $.ajax({
                        url: base_url + "MachineRepairsCostAnalysis/generatePDF",
                        type: "POST",
                        data: filters,
