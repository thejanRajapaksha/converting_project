...
function editFunc(id) {
  Swal.fire({
    title: 'Edit Machine Brand?',
    text: 'Do you want to edit this machine brand?',
    icon: 'warning',
...
function removeFunc(id) {
  Swal.fire({
    title: 'Are you sure?',
    text: "This will permanently delete the machine brand!",
    icon: 'warning',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        url: base_url + 'MachineBrands/remove', // ensure this is correct
        type: 'post',
