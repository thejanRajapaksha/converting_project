        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    ...
                    button += '<a href="#" class="btn btn-danger btn-sm btnDeletenewpurchaseorder" data-url="<?php echo base_url() ?>Newpurchaserequest/DeleteNewPurchaseOrderRequest/' +
							full['idtbl_print_porder_req'] +
							'/3" ';
						if (deletecheck != 1) {
							button += 'd-none';
...
$(document).on('click', '.btnDeletenewpurchaseorder', function (e) {
	e.preventDefault();
