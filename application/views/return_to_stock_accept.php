                ...
                <div class="container-fluid">
                    <div class="page-header-content py-3">
                        <h1 class="page-header-title font-weight-light">
                            ...
                            <span>Service Item Return To Stock Accept</span>
                        </h1>
                    </div>
                </div>
            </div>
                ...
                <div class="modal fade" tabindex="-1" role="dialog" id="editModal">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            ...
                            <form role="form" action="<?php echo base_url('MachineService/update_return_to_stock_accept') ?>" method="post"
                                id="updateForm">
                ...
                <div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form role="form" action="<?php echo base_url('MachineService/remove_return_to_stock_accept') ?>" method="post"
                                id="removeForm">
                                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        manageTable = $('#manageTable').DataTable({
            'ajax': base_url + 'MachineService/fetchCategoryDataReturnToStockAccept',
            'order': []
        });
    ...
    {
        $.ajax({
            url: base_url + 'MachineService/fetchReturnedServiceItemsAccept/'+id,
            type: 'post',
            dataType: 'json',
            success:function(data) {
