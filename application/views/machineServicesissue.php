            ...
            success:function(data) {
                ...
                $.each(response, function(index, value) {
                    res_tr += '<tr>' +
                        ...
                        '</tr>';
                        let qty = parseFloat(value.issued_qty) || 0;
                ...
                res_table += "<div class='table-responsive mt-3'>" +
                    " ";
                res_table += '<table class="table table-striped table-sm" id="viewTable">';
                let res_tr1 = '<thead><tr><th>Service Item</th> <th> Issued Quantity </th> <th>Unit Price</th> <th>Date</th>  </tr></thead> <tbody>';
