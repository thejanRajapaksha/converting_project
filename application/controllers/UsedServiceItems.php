...
class UsedServiceItems extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('usedserviceitems', $result);
    }
    ...
    public function fetchCategoryData()
    {
        ...
        foreach ($data as $key => $value) {
            ...
            $buttons .= '<button type="button" class="btn btn-primary btn-sm" onclick="viewFunc('.$value['id'].', \''.$date_from.'\', \''.$date_to.'\', \''.$value['name'].'\')" data-toggle="modal" data-target="#viewModal"><i class="fas fa-eye"></i></button>';
