...
class MachineService extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('machineService', $data);
    }
    ...
    public function fetchAllocatedServiceItems($service_id)
{
    ...
    public function allocate()
    {
        $this->load->model('Commeninfo');
        $data['menuaccess'] = $this->Commeninfo->Getmenuprivilege();
        $this->load->view('machineServiceallocate', $data);
    }
    ...
    public function issue()
    {
        $this->load->model('Commeninfo');
        $data['menuaccess'] = $this->Commeninfo->Getmenuprivilege();
        $this->load->view('machineServicesissue', $data);
    }
    ...
    public function fetchCategoryDataIssue()
{
    ...
    public function receive()
    {
        $this->load->model('Commeninfo');
        $data['menuaccess'] = $this->Commeninfo->Getmenuprivilege();
        $this->load->view('machineServicereceive', $data);
    }
