...
class MachineOverallCost extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('machineoverallcost', $result);
    }
    ...
    public function generatePDF()
    {
        ...
        $this->load->model('MachineOverallCostinfo'); 
        $rows = $this->MachineOverallCostinfo->getMachineOverallCostForPDF($filters);
        $this->MachineOverallCostinfo->generateMachineOverallCostPDF($rows);
    }
