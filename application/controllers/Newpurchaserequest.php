...
class Newpurchaserequest extends CI_Controller
{
	public function index()
	{
		...
		$result['prefilled_sparepart'] = $this->input->get('sparepart');
		$result['prefilled_suggested_qty'] = $this->input->get('suggested_qty');
		$result['prefilled_current_stock'] = $this->input->get('current_stock');
		$result['prefilled_reorder_level'] = $this->input->get('reorder_level');
		$result['prefilled_part_no'] = $this->input->get('part_no');
		$result['prefilled_sparepart_id'] = $this->input->get('sparepart_id');
